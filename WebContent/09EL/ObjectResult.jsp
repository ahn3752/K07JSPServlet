...
<body>
	...
	<%
	/*
	Java코드를 통해 영역에 저장된 속성을 가져올떄는 아래와 같이 한다.
	...
	*/
	...
	<!-- 
		...
		따라서, java코드를 사용할때보다 EL을 사용하면 훨씬 간편해진다.
	 -->
